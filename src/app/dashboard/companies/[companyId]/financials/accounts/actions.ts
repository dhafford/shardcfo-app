...
const TEMPLATES: Record<TemplateType, TemplateAccount[]> = {
  saas: [
    ...
    // Sales & Marketing
    { account_number: "6000", name: "Sales Salaries", category: "operating_expense", subcategory: "sales_marketing", display_order: 200 },
    { account_number: "6010", name: "Marketing Spend", category: "operating_expense", subcategory: "sales_marketing", display_order: 210 },
    { account_number: "6020", name: "Advertising", category: "operating_expense", subcategory: "sales_marketing", display_order: 220 },
    // R&D
    { account_number: "6100", name: "Engineering Salaries", category: "operating_expense", subcategory: "research_development", display_order: 300 },
    { account_number: "6110", name: "Development Tools", category: "operating_expense", subcategory: "research_development", display_order: 310 },
    // G&A
    { account_number: "6200", name: "Executive Salaries", category: "operating_expense", subcategory: "general_administrative", display_order: 400 },
    { account_number: "6210", name: "Finance & Legal", category: "operating_expense", subcategory: "general_administrative", display_order: 410 },
    { account_number: "6220", name: "Office & Facilities", category: "operating_expense", subcategory: "general_administrative", display_order: 420 },
    { account_number: "6230", name: "Insurance", category: "operating_expense", subcategory: "general_administrative", display_order: 430 },
  ],
  ecommerce: [
    ...
    { account_number: "6000", name: "Marketing & Advertising", category: "operating_expense", subcategory: "sales_marketing", display_order: 200 },
    { account_number: "6010", name: "Platform Fees", category: "operating_expense", subcategory: "sales_marketing", display_order: 210 },
    { account_number: "6100", name: "Technology", category: "operating_expense", subcategory: "research_development", display_order: 300 },
    { account_number: "6200", name: "General & Administrative", category: "operating_expense", subcategory: "general_administrative", display_order: 400 },
    { account_number: "6210", name: "Warehouse & Operations", category: "operating_expense", subcategory: "general_administrative", display_order: 410 },
  ],
  professional_services: [
    ...
    { account_number: "6000", name: "Business Development", category: "operating_expense", subcategory: "sales_marketing", display_order: 200 },
    { account_number: "6100", name: "Staff Salaries", category: "operating_expense", subcategory: "general_administrative", display_order: 300 },
    { account_number: "6110", name: "Benefits & HR", category: "operating_expense", subcategory: "general_administrative", display_order: 310 },
    { account_number: "6200", name: "Rent & Utilities", category: "operating_expense", subcategory: "general_administrative", display_order: 400 },
    { account_number: "6210", name: "Professional Fees", category: "operating_expense", subcategory: "general_administrative", display_order: 410 },
  ],
  blank: [],
};
